...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "ZChat" },
      ...
      { property: "og:image", content: "https://z-chat-five.vercel.app/og-image.png" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:url", content: "https://z-chat-five.vercel.app/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "ZChat" },
      { name: "twitter:description", content: "Fast, private messaging with friends and groups." },
      { name: "twitter:image", content: "https://z-chat-five.vercel.app/og-image.png" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "manifest", href: "/manifest.webmanifest" },
      { rel: "icon", type: "image/png", href: "/favicon.png" },
      { rel: "apple-touch-icon", href: "/icons/z-512.png" },
      { rel: "canonical", href: "https://z-chat-five.vercel.app/" },
